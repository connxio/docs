...
Add an Azure File Share trigger to your integration and configure the settings below.
...
<PropertyReference properties={[
  ...
  },
  {
    ...
    description: "Required. The file share to retrieve files from.",
  },
  {
    name: "Directory",
    description: "Required. The directory in the file share to retrieve files from.",
  },
]} />
...
<PropertyReference properties={[
  {
    name: "Pick limit",
    description: "Optional. The maximum number of files to retrieve per pickup. Use this to limit the load on receiving services.",
  },
  {
    name: "Wrapper",
