...
- **Variable name**: The name used for the variable through Connxio. USe this name if you want to target the variable in a [code component](./code-transformation.md) or [Connxio Macro Language](../cxmal/connxio-macro-language.md).
...
- **Security Configuration**: Select your security configuration from the list. See [here](../integrations/security-configurations.md) for more information.
