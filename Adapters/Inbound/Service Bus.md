...
- **FileName**: Used for [variable replacement](/Transformation/Variable%20Replacement.md).
- **InterchangeId**: Used as InterchangeId as detailed in [core concepts](/Core%20Concepts.md).
