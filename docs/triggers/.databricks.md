...
- **Security configuration**: Reference to the [Security Configuration](../../../integrations/security-configurations.md#Databricks) that contains the relevant connection properties.
