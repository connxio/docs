...
Before starting to use Connxio, you should read about [why we created Connxio](/concepts/why-connxio) and some of the [core concepts behind it](/concepts/core-concepts).
