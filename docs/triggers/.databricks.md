...
- **Security configuration**: Reference to the [Security Configuration](../../../connxio-portal/security-configurations.md#Databricks) that contains the relevant connection properties.
