...
<br />
<a style={{ fontSize: '1.25rem', fontWeight: '500', padding: '.75rem 2rem'}} href="https://app-cx-dt-ratchet-api.azurewebsites.net/index.html" className="action-button">Connxio API Definition</a>
