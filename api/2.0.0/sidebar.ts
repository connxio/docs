  ...
  apisidebar: [
    ...
    },
    {
      ...
      items: [
        {
          type: "doc",
          id: "2.0.0/get-api-v-2-integrations",
          label: "List all integrations",
          className: "api-method get",
        },
        {
          type: "doc",
          id: "2.0.0/post-api-v-2-integrations",
          label: "Upsert an integration",
          className: "api-method post",
        },
        {
          type: "doc",
          id: "2.0.0/get-api-v-2-integrations-id",
          label: "Find integration by id",
          className: "api-method get",
        },
        {
          type: "doc",
          id: "2.0.0/put-api-v-2-integrations-id",
          label: "Update integration by id",
          className: "api-method put",
        },
        {
          type: "doc",
          id: "2.0.0/delete-api-v-2-integrations-id",
          label: "Delete integration by id",
          className: "api-method delete",
        },
        {
          type: "doc",
          id: "2.0.0/post-api-v-2-integrations-novalidation",
    ...
    },
    {
      ...
      items: [
        {
          type: "doc",
          id: "2.0.0/post-api-v-2-messages-integration-id",
          label: "Sends a single message to Connxio",
          className: "api-method post",
        },
        {
          type: "doc",
          id: "2.0.0/post-api-v-2-messages-integration-id-batch",
          label: "Sends a batch of messages to Connxio",
          className: "api-method post",
        },
        {
          type: "doc",
          id: "2.0.0/post-api-v-2-messages-integration-id-eventgrid",
