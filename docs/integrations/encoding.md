...
- **Rest Adapter**: The payload can be received as `application/octet-stream`. See the [REST page](../actions/http.md#receive-content-as-bytes). You may still need to make a conversion from Base64 string.
