...
Before starting to use Connxio, you should read about [why we created Connxio](/getting-started/why-connxio) and some of the [core concepts behind it](/getting-started/connxio-concepts).
