  ...
  apisidebar: [
    ...
    },
    {
      ...
      items: [
        {
          type: "doc",
          id: "1.0.0/get-api-v-1-management-integration",
          label: "Gets a list of integration configurations for the subscription",
          className: "api-method get",
        },
        {
          type: "doc",
          id: "1.0.0/post-api-v-1-management-integration",
          label: "Creates or updates an integration configuration",
          className: "api-method post",
        },
        {
          type: "doc",
          id: "1.0.0/get-api-v-1-management-integration-id",
          label: "Gets the integration configuration corresponding to the configCorrelationId",
          className: "api-method get",
        },
        {
          type: "doc",
          id: "1.0.0/delete-api-v-1-management-integration-id-subscription-subscription-id",
    ...
    },
    {
      ...
      items: [
        {
          type: "doc",
          id: "1.0.0/post-api-v-1-message",
          label: "Sends a single message to Connxio",
          className: "api-method post",
        },
        {
          type: "doc",
          id: "1.0.0/post-api-v-1-message-new-batch",
          label: "Sends a batch of messages to Connxio",
          className: "api-method post",
        },
        {
          type: "doc",
          id: "1.0.0/post-api-v-1-message-new",
          label: "Sends a single message to Connxio",
          className: "api-method post",
        },
        {
          type: "doc",
          id: "1.0.0/post-api-v-1-eventgrid",
    ...
    },
    {
      ...
      items: [
        {
          type: "doc",
          id: "1.0.0/post-api-v-1-resend-archeo",
    ...
    },
    {
      ...
      items: [
        {
          type: "doc",
          id: "1.0.0/get-api-v-1-management-subscription",
