...
- **Variable name**: The name used for the variable through Connxio. Use this name if you want to target the variable in a [code component](./code-components.md) or [Connxio Macro Language](../integrations/cxmal/connxio-macro-language.md). The variable is added to the DataCollection array on the Metadata object.

## Retry

Blob Get is currently using the backoff retry described on the [Retry](../integrations/retry.md) page.
