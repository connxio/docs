...
- **Rest Adapter**: The payload can be received as `application/octet-stream`. See the [REST page](./adapters/outbound/rest.md#receive-content-as-bytes). You may still need to make a conversion from Base64 string.
- **Rest Adapter**: The payload can be received as `application/octet-stream`. See the [REST page](./adapters/outbound/rest.md#receive-content-as-bytes). You may still need to convert it from a Base64 string.
