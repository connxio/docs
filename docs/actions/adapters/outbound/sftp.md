...
- **Cron Expression**: Specifies the frequency at which the batching operation is triggered. Read more about the triggering interval [here](../../../integrations/triggering-interval.md).
...
- **Outbound Filename Pattern**: Uses Connxio Macro Language to generate file names, this is described in detail on the [Connxio Macro Language](../../../integrations/cxmal/connxio-macro-language.md) page.
...
Retry on all outbound adapters is currently handled by the backoff retry described on the [Retry page](../../../integrations/retry.md).
